...
class GwardenApplication(Adw.Application):
    ...
    def __init__(self):
        ...
        self.create_action('logout', lambda _,__ : login_state_manager.set_state(False))
        timeout_id = GLib.timeout_add(100, controller.run)
    ...
    def on_about_action(self, widget, _):
        ...
        about = Adw.AboutWindow(transient_for=self.props.active_window,
                                ...
                                application_icon='com.gwarden.mwickham.github',
                                developer_name='Max Wickham <maxwickham@startmail.com>',
...
#     def __init__(self):
#         super().__init__(application_id='com.github.mwickham.gwarden',
#                          flags=Gio.ApplicationFlags.DEFAULT_FLAGS)
#         self.create_action('quit', lambda *_: self.quit(), ['<primary>q'])
#         self.create_action('about', self.on_about_action)
